							...
							<tr>
								<td>
									...
									<xsl:if test="notification_data/incoming_request/format='DIGITAL'">
										<xsl:if test="notification_data/metadata/material_type='Article' or 'Book' ">
											<xsl:text/>
											<xsl:choose>
												<xsl:when test="/notification_data/metadata/chapter_title != ''">
													<xsl:value-of select="/notification_data/metadata/chapter_title"/>
												</xsl:when>
												<xsl:otherwise>
													<xsl:value-of select="/notification_data/incoming_request/title"/>
												</xsl:otherwise>
											</xsl:choose>
										</xsl:if>
									</xsl:if>
...
-->
							...
							<tr>
								<td>
									<b>@@publisher@@:&#160;</b>
									<xsl:text/>
									<xsl:value-of select="/notification_data/items/physical_item_display_for_printing/imprint"/>
								</td>
							</tr>
							<!--							</xsl:if>    -->
...
-->
							<tr>
								<td>
									...
									<xsl:choose>
										...
										<xsl:otherwise>
											Doe Library - Main (Gardner) Stacks
										</xsl:otherwise>
									</xsl:choose>
									<!--									<b>@@library@@: </b>
									<xsl:value-of select="/notification_data/items/physical_item_display_for_printing/library_name"/>  -->
							...
							<tr>
								<td>
									<b>@@location@@: </b>
									<xsl:value-of select="/notification_data/items/physical_item_display_for_printing/location_name"/>
								</td>
							</tr>
...
-->
							<tr>
								<td>
									<b>Resource Sharing Request ID: </b>
...
-->
							...
							<tr>
								<td>Lending Services Department</td>
							</tr>
							<tr>
								<td>Resource Sharing Division</td>
							</tr>
							<tr>
								<td>UC Berkeley Library - CUY</td>
							</tr>
						</table>
					</div>
				</div>
