### Script to combine Lynne's downloaded Excel files into one spreadsheet. I manually separated
### the files based on the number of columns (8, 9, and 10) and processed each group individually.
...
# Write output file
write.csv(df_combined_csvs, file = "hathi_all_files_combined.csv", row.names = FALSE)
